...
if __name__ == "__main__":
    ...
    for db, injection_data_set in injection_datas.items():
        for curr_injection_idx, injection_data in enumerate(injection_data_set):
            ...
            data_out_path = "../../outputs/incoder_injectionpromptvgradientdescent_spider_pretrained_test1/tk_injection_add_description_%s_%d_datapoints_%d_per_prompt____%s/" % (str(add_description), n_per_prompt*(curr_injection_idx+1), n_per_prompt, db)
            ...
            distill_data = generate_distillation_data(
                ...
                bsize=1, n_per_question=1, max_input_length=in_length, max_output_length=512, 
