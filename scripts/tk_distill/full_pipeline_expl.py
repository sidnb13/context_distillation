...
if __name__ == "__main__":
    ...
    for task, add_negatives, add_positives in tasks:
        ...
        data_out_path = "../../outputs/inject2negv2negexpl_test10/tk_inject_%s_%s___%s/" % ('2_negative' if add_negatives else '', '2_positive' if add_positives else '', task)
        ...
        questions = injection_data.dataset_questions
        questions = questions[:4096]
        ...
        distill_data = generate_distillation_data(
            ...
            bsize=16, n_per_question=4096//len(questions), max_input_length=1024, max_output_length=128, 
        ...
        trainer = distill(all_distill_data, trainer, mesh, bsize=8, epochs=1, max_input_length=1024, rng_key=new_rng, decompress_smoothing_epsilon=1e-7, 
                          wandb_run_name=task, wandb_project_name='inject_explanations')
