...
if __name__ == "__main__":
    ...
    data_out_path = "../../outputs/scratch_from_scratchpad_direct_test3/"
    model_out_path = "../../outputs/scratch_from_scratchpad_direct_test3/model/"
    # model_out_path = None
    ...
    if jax.process_index() == 0 and use_wandb:
        wandb.init(project='addition_scratchpads_iclr', name='direct_test3')
